...
Label(root,image=login_icon,border='0',bg='#91a3b0',).place(y=100,x=50)

login_frame = Frame(root,width=350,height=390,bg='#91a3b0')
#login_frame.config(borderwidth=5,relief='ridge')
login_frame.place(y=50,x=480)

login_label = ttk.Label(login_frame,foreground='#9bddff',background='#91a3b0',text='Login',font=('Dubai',22,'bold'))
...
username_entry =Entry(login_frame,width=25,border=0,background='#91a3b0',foreground='#9bddff',font=('Dubai',11))
...
Button(login_frame,width=30,pady=7,text='Login',bg='#9bddff',fg='white').place(x=30,y=200)
